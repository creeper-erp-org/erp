...
SECRET_KEY = 'django-insecure-9#v*_qc7q145v0q!k!^t99amc5qw_3xw!&p2fx+lrcrevg*6jx'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get("POSTGRES_NAME"),  # Or path to database file1 if using sqlite3.
